...
class Algorithm:
    ...
    def find_heir(self):
        ...
        print("CHILDREN", list(map(lambda x: f"{x.personal_info.name} {x.personal_info.surname}",  self.testator.children)))
        print("PARENTS", list(map(lambda x: f"{x.personal_info.name} {x.personal_info.surname}",  self.testator.parents)))
        print("SIBLINGS", list(map(lambda x: f"{x.personal_info.name} {x.personal_info.surname}",  self.testator.siblings)))
        print("SPOUSE", list(map(lambda x: f"{x.personal_info.name} {x.personal_info.surname}",  self.testator.spouse)))
